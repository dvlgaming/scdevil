...
module.exports = devil = async (devil, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = devil.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "LIST COMMAND","footerText": "BY DEVILBOTZ \nSILAHKAN PILIH COMMAND","listType": "SINGLE_SELECT","sections": list}}, {})
...
┃⬡ Contact : @${tagme} 
┃⬡ Instagram :
┃⬡ *https://instagram.com/devilbotz12*
┃⬡ YouTube : https://youtube.com/channel/UCMnHBMYarAeDtfdoWpQF7hA
┃⬡ Official Group :
┃⬡ *https://chat.whatsapp.com/KZc6UI1LbTKFeSZnWnfBcq*
┗⬣
